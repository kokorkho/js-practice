...
a = document.getElementById('six').innerHTML = 'Hello World';
...
a1 = document.getElementById('seven').innerHTML = 12 * 12;
...
a3 = document.querySelector('.out-9');
...
a4 = document.querySelector('.out-10');

a4.innerHTML = '<h2>Hi</h2>';
...
let a12 = document.querySelector('.out-12');
