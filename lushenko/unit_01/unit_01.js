...
console.dir(div6);
// div6.innerText = '<span>Hello World</span>';
div6.innerHTML = '<span>Hello World</span>';
...
console.dir(document.getElementById('seven'));
// Task 8.
...
// Task 10.
//На странице создан div.out-10. С помощью innerHTML запишите внутрь него следующую строку'< h2>Hi</>'.
