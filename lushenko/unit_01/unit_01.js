...
let i8 = document.querySelector(".out-8");
i8.innerHTML = "task-8";
...
let out199 = document.querySelector(".out-19-test");

// out19.innerHTML = out199;

console.log((out19 = out199));
