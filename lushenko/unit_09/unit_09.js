...
function f12() {
  ...
  nev.innerHTML = "12";
  nev.classList.add("bg-12");
  console.log(nev);
  out12.appendChild(nev);
}
...
function f13() {
  let nev13 = document.createElement("div");
  nev13.innerHTML = "pushMe";
  nev13.classList.add("bg-orange");
  nev13.onclick = f13_1;
  out13.appendChild(nev13);
}
...
function f14() {
  let nev14 = document.createElement("div");
  nev14.innerHTML = "14";
  nev14.classList.add("bg-orange");
  out14.appendChild(nev14);
}
...
function f15() {
  let nev15 = document.createElement("div");
  nev15.innerHTML = "15";
  nev15.classList.add("bg-orange");
  out15.appendChild(nev15);
}
...
function f16() {
  let nev16 = document.createElement("div");
  nev16.innerHTML = "16";
  nev16.classList.add("bg-orange");
  out16.appendChild(nev16);
}
...
function f17() {
  let nev17 = document.createElement("div");
  nev17.innerHTML = "17";
  nev17.classList.add("bg-orange");
  out17.appendChild(nev17);
}
