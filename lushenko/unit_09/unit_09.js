...
function f4() {
  ...
  console.dir(out4.classList.contains(out4.classList[1]));
}
...
//  Task 10
// Усложним предыдущие задачи. С помощью цикла ловим на блоки .out-10 событие клик. По клику должна выполняться функция f10. Функция, должна делать toggle класса .bg-orange тому .out-10 на котором кликнули.
...
function f11() {
  let out11 = document.createElement("div");
  out11.innerHTML = "25";
  console.log(out11);
  div11.appendChild(out11);
}
