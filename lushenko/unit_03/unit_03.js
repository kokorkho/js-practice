...
function f14() {
  let s14 = document.querySelector(".s-143").value;
  let result = "";
  let i14 = +document.querySelector(".i-141").value;
  let i15 = +document.querySelector(".i-142").value;
  console.log({ out14, i14, i15, s14 });
