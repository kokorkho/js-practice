...
let input2 = document.querySelector(".i-31");
let input3 = document.querySelector(".i-32");
let out3 = document.querySelector(".out-3");

function f3() {
  if (input2 > input3) {
    out3.innerHTML = input2.value;
  } else {
...
function f7() {
  out7.innerHTML = (+input71.value) ** +input72.value;
}
...
function f8() {
  let select1 = document.querySelector("s-8");
...
function f12() {
  let value = i120.value;
  document.querySelector(".out-12").innerHTML = typeof value;
}
...
function f14() {
  let value1 = +i141.value;
  let value2 = +i142.value;
  let operator = s143.value;
  let result;
...
let select5 = document.querySelector('.s-153');
let out15 = document.querySelector('.out-15');

function f15() {
  let value1 = s151.value;
  let value2 = s152.value;
  let operator = select5.value;
  let result;
