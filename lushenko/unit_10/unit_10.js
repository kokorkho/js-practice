...
let ar1 = ["Иван", 30, true]; // переменную обьявляем здесь!!!!
...
let ar2 = ["Иван", 33, true]; // переменную обьявляем здесь!!!!
...
let ar3 = ["Иван", 34, "Овен"]; // переменную обьявляем здесь!!!!
...
let ar6 = ["Мухаммад", "Скорпион", "Октябрь"];
