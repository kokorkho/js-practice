...
document.querySelector(".out-4").textContent = c1 + f1;
...
function t12() {
  out12.innerHTML = "Hello" + " " + input1.value + " " + input2.value;
}
...
let a1 = document.querySelector(".i-13-1");
let b2 = document.querySelector(".i-13-2");

function t13() {
  out13.innerHTML = +a1.value + +b2.value;
}
...
let i16 = document.querySelector(".i-16-1");
let i17 = document.querySelector(".i-16-2");

function t16() {
  out16.innerHTML = i16.value + i17.value;
}
...
let i19 = document.querySelector(".i-19-1");
let i129 = document.querySelector(".i-19-2");

function t19() {
  out19.innerHTML = +i19.value + +i129.value;
}
